...
class TestChatClient(TestCase):
    ...
    def test_message_data_valid_or_raiserror(self):
        ...
        expected = "Incorrect input. Please, check if action " + \
            "'message' and input message data."
    ...
    def test_send_message(self):
        ...
        stub = mock.Mock(SendMessage=mock.Mock())
        chat_client.send_message(args, stub)
        message = chat_pb2.Message(login_from="userA",
                                   login_to="userB",
                                   body="Hello.")
        stub.SendMessage.assert_called_once_with(
